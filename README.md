...
Подробнее: [ARCHITECTURE.md](ARCHITECTURE.md), [ROUTING.md](ROUTING.md), [OCR_PIPELINE.md](OCR_PIPELINE.md), [EVAL.md](EVAL.md), [QUICKSTART.md](QUICKSTART.md), [docs/FINETUNING.md](docs/FINETUNING.md) (первый цикл SFT: Qwen2.5-14B-Instruct, датасеты, объёмы).
